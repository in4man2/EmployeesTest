namespace Employees.Models
{
    ...
    public class EFModel1 : DbContext
    {
        ...
        // "EmployeeesAndStudents.Models.EFModel1" в экземпляре LocalDb. 
        // 
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<EmployeeEntity>().HasKey(t => t.ID);

             modelBuilder.Entity<EmployeeEntity>().HasRequired(m => m.JobTitleEntity);
        ...
        public virtual DbSet<JobTitleEntity> JobTitleEntities { get; set; }
